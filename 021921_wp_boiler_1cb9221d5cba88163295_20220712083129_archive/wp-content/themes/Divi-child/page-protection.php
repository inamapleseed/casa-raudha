			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<?php endif; ?>
					...
					<div class="entry-content">
                        ...
                        <div class="restoration-box-bottom protection-box">
                            <div class="repeater-box-2">
                                <?php $repeater2 = get_field('repeater_protection');  foreach($repeater2 as $m => $r2): ?>
                        ...
                        <div class="btn-con protect">
                            <a class="btn-green" href="<?php echo get_field('button_link_1'); ?>"><?php echo get_field('button_name_1'); ?></a>

                            <a class="btn-green" href="<?php echo get_field('button_link_2'); ?>"><?php echo get_field('button_name_2'); ?></a>
                        </div>                        
					</div> <!-- .entry-content -->

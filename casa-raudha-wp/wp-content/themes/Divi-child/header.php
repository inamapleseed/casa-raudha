...
?>
	...
	<?php ob_start(); ?>
		<header id="main-header" style="background: url('<?php echo get_field('header_background_image', 'option')?>');background-position: center;background-repeat: no-repeat;" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
		<?php 
		...
		<div class="container clearfix et_menu_container header-con">
			<?php
			...
			?>
				<div class="top-corn">
					...
					<?php $arr = get_field('contact_info', 'option');
						foreach($arr as $ar):
					?>
						<h5><img src="<?php echo $ar['icon']; ?>" alt="image"><?php echo $ar['text']; ?></h5>
					<?php endforeach ?>
			...
			?>
				<div class="bottorm">
					<div id="et-top-navigation" class="menu-items" data-height="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>" data-fixed-height="<?php echo esc_attr( et_get_option( 'minimized_menu_height', '40' ) ); ?>">
						<?php if ( ! $et_slide_header || is_customize_preview() ) : ?>
							<nav id="top-menu-nav">
							<?php
								$menuClass = 'nav';
					...
					<a class="btn-pink deskt" style="text-align: center; background: <?php echo get_field('button_background_color', 'option'); ?>" href="<?php echo get_field('url', 'option'); ?>"><?php echo get_field('button_title', 'option'); ?></a>
				</div>
			</div> <!-- .container -->
		...
		<a class="btn-pink mobile" style="text-align: center; background: <?php echo get_field('button_background_color', 'option'); ?>" href="<?php echo get_field('url', 'option'); ?>"><?php echo get_field('button_title', 'option'); ?></a>
		...
		<style>
			@media (min-width: 768px) {
				...
				.home #main-header.et-fixed-header {
					background: url('<?php echo get_field('header_background_image', 'option')?>') !important;

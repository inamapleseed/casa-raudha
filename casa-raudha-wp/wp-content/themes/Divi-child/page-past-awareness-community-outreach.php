					...
					<div class="entry-content">
						...
						<div class="awareness-box">
                            ...
                            <div class="repeater-box">
                                <?php $repeater1 = get_field('repeater_outreach');  foreach($repeater1 as $i => $r1): ?>
                                    <div class=" row-inner">
                                        ...
                                        <div class="texts animate-up">
                                            ...
                                            <div class="date"><?php echo $r1['r_date']; ?></div>
                            ...
                            <div class="btn-con ">
                                <a class="btn-green" href="<?php echo get_field('button_link'); ?>"><?php echo get_field('button_name'); ?></a>
                            </div>
                        </div>
					</div> <!-- .entry-content -->
